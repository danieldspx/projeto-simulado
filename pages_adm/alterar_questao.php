<?php
    ...
    $busca = DBSearch("questoes","WHERE ano = $ano AND numero = $numero;");
        ...
        <div class="row" style="margin: 30px 0px;">
            <div role="main" class="col-md-12 col-xs-12">
                <form class="form-horizontal" action="add_questao.php" method="POST">
                    ...
                    <div class="col-md-1">
                    <input id="id" name="idquestao" type="number" placeholder="" <?php echo "value=\"".$busca[0]['idquestao']."\"";?> class="form-control input-md" required="">
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                    <label class="col-md-4 control-label" for="anoProva">Ano</label>
                    <div class="col-md-2">
                    <input id="anoProva" name="anoProva" type="number" placeholder="" <?php echo "value=\"".$busca[0]['ano']."\"";?> class="form-control input-md" required="">
                    ...
                    <div class="col-md-5">
                        <select id="disciplina" name="disciplina" class="form-control">
                            <?php
                                $string = "<option value=\"1\">Física</option> <option value=\"2\">Matemática</option> <option value=\"3\">Química</option> <option value=\"4\">Biologia</option> <option value=\"5\">Português</option> <option value=\"6\">História</option> <option value=\"7\">Sociologia</option> <option value=\"8\">Filosofia</option> <option value=\"9\">Inglês</option> <option value=\"10\">Espanhol</option> <option value=\"11\">Artes</option> <option value=\"12\">Geografia</option>";
                                $string = str_replace("value=\"".$busca[0]['disciplinas_id_disciplina']."\"","value=\"".$busca[0]['disciplinas_id_disciplina']."\" selected",$string);
                                echo $string;
                            ?>
                        </select>
                    </div>
