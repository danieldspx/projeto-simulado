...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
        ...
        <div class="login" id="loginID">
            <div class="login-center">
                ...
                <form class="form-horizontal" method="POST" action="../valida/valida.php">
                    ...
                    <button id="loginB" class="btn btn-block btn-lg btn-primary">Efetuar Log-in&nbsp;&nbsp;<i class="fas fa-sign-in-alt" aria-hidden="true"></i></button>
                </form>
            </div>
        </div>
	...
	c6.1-9.3,16-12.1,16-21.2C32,3.8,28.2,0,23.6,0z"/></svg> 
                &nbsp;by<br>Daniel dos Santos Pereira
            </div>
        </div>
        <footer class="row">
            <div class="container">
            ...
            <div class="col-md-4 col-sm-6 footerleft" style="color: azure;">
                ...
                are licensed by <a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0" target="_blank" rel="noopener">CC 3.0 BY</a></div>
            </div>
    ...
    <script>
        ...
        window.sr = ScrollReveal({ reset: true, delay: 0, duration: 700, distance: '20%',mobile: true});
        ...
        document.querySelectorAll('.lazy-load').forEach(elem => io.observe(elem));
