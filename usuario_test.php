...
<html>
    <head>
        ...
        <link href="css/usuario_teste.css" rel="stylesheet" type="text/css"/>      
        ...
        <?php
            if($is_mobile){
                ...
                echo "<link href='css/mobile_usuario_test.css' rel='stylesheet'>"; 
            }
        ?>
    </head>
        ...
        <div id="main" class="col-md-12">
                    ...
                    <div class="imgSection">
                       <?php
                        ...
                        <div style="width:100%; text-align:center; position: absolute;">
                            <div id="placeImg"><img src="img/Aluno.png" width="100%" height="100%" alt="Imagem de Perfil"></div>
                        </div>
                    </div>
                    <div class="corpoSide">
            ...
            <div class="rside col-md-9">
               ...
               <?php
                    ...
                    $pesquisa = DBSearch("usuarios","WHERE id = ".$_SESSION['usuario']['id'],"nome,sobrenome,email,matricula,instituicao,ano,celular,foto_perfil");
                    $dados = $pesquisa[0];
                    unset($pesquisa);
                        ...
                        <div class="form">
                            ...
                            <div class="row">
                               <div class="groupForm col-sm-offset-1 col-md-offset-1 col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <div id="viewIcon"><img src="img/ViaLactea.png" id="imgView" alt="Imagem de Pre-View" width="100%"></div>
                                </div>
                                <div class="groupForm col-xs-12 col-sm-4 col-md-4">
                                    <label for="nCelular">Celular</label>
                                    <input type="text" name="nCelular" <?php echo "value='".$dados['celular']."'"; ?> id="nCelular">
                                </div>
                                <div class="row col-xs-12 col-sm-12 col-md-12" style="text-align: center; margin-top: 40px;">
                                    <button class="btnForm">Salvar <i class="material-icons" style="margin-left: 5px;">save</i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form">
                            ...
                            <div class="row col-md-12">
                                <div class="groupForm col-md-6 col-sm-12">
                                    <label for="nSenha">Senha Nova</label>
                                    <input type="text" name="nSenha" id="nSenha">
                                </div>
                                <div class="groupForm col-md-6 col-sm-12">
                                    <label for="nSenhaConf">Confirmação</label>
                                    <input type="text" name="nSenhaConf" id="nSenhaConf">
                                </div>
                            </div>
                            <div class="row col-md-12">
